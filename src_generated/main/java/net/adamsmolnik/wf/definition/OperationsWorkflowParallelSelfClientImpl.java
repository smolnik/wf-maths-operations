...
public class OperationsWorkflowParallelSelfClientImpl extends WorkflowSelfClientBase implements OperationsWorkflowParallelSelfClient {

    public OperationsWorkflowParallelSelfClientImpl() {
        this(null, new com.amazonaws.services.simpleworkflow.flow.JsonDataConverter(), null);
    }

    public OperationsWorkflowParallelSelfClientImpl(GenericWorkflowClient genericClient) {
        this(genericClient, new com.amazonaws.services.simpleworkflow.flow.JsonDataConverter(), null);
    }

    public OperationsWorkflowParallelSelfClientImpl(GenericWorkflowClient genericClient, DataConverter dataConverter,
