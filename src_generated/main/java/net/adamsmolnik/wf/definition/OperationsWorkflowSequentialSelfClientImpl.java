...
public class OperationsWorkflowSequentialSelfClientImpl extends WorkflowSelfClientBase implements OperationsWorkflowSequentialSelfClient {

    public OperationsWorkflowSequentialSelfClientImpl() {
        this(null, new com.amazonaws.services.simpleworkflow.flow.JsonDataConverter(), null);
    }

    public OperationsWorkflowSequentialSelfClientImpl(GenericWorkflowClient genericClient) {
        this(genericClient, new com.amazonaws.services.simpleworkflow.flow.JsonDataConverter(), null);
    }

    public OperationsWorkflowSequentialSelfClientImpl(GenericWorkflowClient genericClient, DataConverter dataConverter,
    ...
    protected void executeImpl(final Promise<Double> a, final Promise<Double> b, final StartWorkflowOptions schedulingOptionsOverride,
            Promise<?>... waitFor) {
